...
export const systemLogs: SystemLog[] = [
  { id: 'LOG-001', timestamp: '2024-02-15 09:23:45', level: 'INFO', message: 'User USR002 logged in successfully', user: 'sarah@example.com' },
  { id: 'LOG-002', timestamp: '2024-02-15 09:45:12', level: 'INFO', message: 'Withdrawal request WR-001 created for AST-003', user: 'sarah@example.com' },
